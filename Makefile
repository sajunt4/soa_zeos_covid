...
USROBJ = libc.o user-utils.o random.o game.o menu.o # libjp.a
...
user.o:user.c $(INCLUDEDIR)/libc.h $(INCLUDEDIR)/game.h $(INCLUDEDIR)/menu.h

game.o:game.c $(INCLUDEDIR)/libc.h $(INCLUDEDIR)/io.h $(INCLUDEDIR)/random.h

menu.o:menu.c $(INCLUDEDIR)/libc.h $(INCLUDEDIR)/io.h
